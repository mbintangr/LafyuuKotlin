...
class FavoriteProductAdapter(private val context: Context, private val productList: List<Product>) :
    RecyclerView.Adapter<FavoriteProductAdapter.FavoriteProductViewHolder>() {

    class FavoriteProductViewHolder(view: View) : RecyclerView.ViewHolder(view) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): FavoriteProductViewHolder {
        val view = LayoutInflater.from(context).inflate(R.layout.favorite_product_card, parent, false)
